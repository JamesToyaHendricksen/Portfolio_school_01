...
VALUES
  (1, 'PHISHING', 'フィッシング', '偽サイトや偽リンクによる詐取', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
ON CONFLICT (id) DO UPDATE SET
  ...
  email_monitoring = EXCLUDED.email_monitoring,
  sns_monitoring = EXCLUDED.sns_monitoring,
  network_monitoring = EXCLUDED.network_monitoring,
